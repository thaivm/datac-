...
namespace LogViewer.Tests
{
    ...
    /// <summary>
    ///This is a test class for EditCXDIFilterSettingViewModelTest and is intended
    ///to contain all EditCXDIFilterSettingViewModelTest Unit Tests
    ///</summary>
    [TestClass()]
    public class EditCXDIFilterSettingViewModelTest
    {
        ...
        public void MyTestInitialize()
        {
            ...
            target = new PrivateObject(new EditCXDIFilterSettingViewModel(null));
        }
        //
