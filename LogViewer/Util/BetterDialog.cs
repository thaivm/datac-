...
namespace LogViewer.Util
{
    ...
    public partial class BetterDialog : Form
    {
        ...
        static public DialogResult ShowDialogDelete(string title, string largeHeading, string smallExplanation,
            ...
            string leftButton, string rightButton, Image iconSet)
        {
            ...
            //            this.Height = 166; // went from 164 to 168 to improve bottom space on XP.
