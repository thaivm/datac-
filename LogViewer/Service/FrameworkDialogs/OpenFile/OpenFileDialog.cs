...
namespace LogViewer.Service.FrameworkDialogs.OpenFile
{
	/// <summary>
	...
	{
		protected readonly IOpenFileDialog openFileDialog;
		protected WinFormsOpenFileDialog concreteOpenFileDialog;
